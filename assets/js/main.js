...
class FishEgg {
    constructor(canvas) {
        ...
        this.canvas = canvas;
        // Set position
        this.x = window.innerWidth / 2 + (Math.random() * 300 - Math.random() * 300);
...
class FishLarva {
    constructor(canvas, progress) {
        ...
        this.y = window.innerHeight / 2 + (Math.random() * 200 - Math.random() * 200);
...
function createCanvas() {
    ...
    document.querySelector('#particles-js').append(tela);
